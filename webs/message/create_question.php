    ...
    <div class="content_r fl">
        ...
        <form class="form_create">
            <div>
                ...
                <label for="system_msg" class="special">公开提问</label>
                <input type="radio" name="msg_type" id="user_msg" value="1" onchange="changeType()">
                <label for="user_msg" class="special" style="width: 150px;">向医生或教练提问</label>
            </div>
            <div>
                <label for="form_title">问题题目</label>
                <input type="text" id="form_title">
            </div>
            <div>
                <label for="form_content">问题内容</label>
